...
sleep(2)
driver.find_element(By.XPATH,"/html/body/nav/div/div[2]/div/form/div/input").send_keys("iphone")#输入iphone
driver.find_element(By.XPATH,"/html/body/nav/div/div[2]/div/form/button").click()#点击查找
